...
export async function GET() {
  ...
  const [usersByVerification, documentStatuses, listingStatuses, totalUsers, totalListings, recentUsers, recentListings, audits] = await Promise.all([
  ...
  return NextResponse.json({ stats: { totalUsers, pendingUsers: users.PENDING || 0, activeUsers: users.ACTIVE || 0, rejectedUsers: users.REJECTED || 0, pendingDocuments: documents.PENDING || 0, verifiedDocuments: documents.VERIFIED || 0, rejectedDocuments: documents.REJECTED || 0, totalListings: totalListings, pendingListings: properties.PENDING || 0, activeListings: properties.ACTIVE || 0, rejectedListings: properties.REJECTED || 0 }, recentUsers, recentListings, audits });
}