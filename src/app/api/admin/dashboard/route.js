...
export async function GET() {
  try {
    ...
    const [usersByVerification, documentStatuses, listingStatuses, totalUsers, totalListings, totalDocuments, totalDeletedUsers, recentUsers, recentListings, audits] = await Promise.all([
      ...
      prisma.deletedUser ? prisma.deletedUser.count().catch(() => 0) : 0,
