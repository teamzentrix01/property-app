...
export default function RootLayout({children}){return <html lang="en" className={`${fraunces.variable} ${workSans.variable} ${jbMono.variable} h-full`}><body className="min-h-full flex flex-col bg-paper text-ink antialiased pb-16 md:pb-0"><RegisterSW/><SmoothScroll><Navbar/>{children}<Footer/></SmoothScroll></body></html>}
