      ...
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {residences.map((residence) => (
            <div
              key={residence.id}
              className="card-red-hover group overflow-hidden rounded-xl border border-[#c41920] bg-white shadow-[0_5px_25px_rgba(0,0,0,0.05)] transition-all duration-300 hover:bg-[#c41920] hover:border-white hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(0,0,0,0.12)]"
            >
              ...
              <div className="p-4">
                ...
                {/* Button */}
                <Link href={`/listings/${residence.id}`} className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg border border-[#c41920] py-2.5 text-sm font-semibold text-[#c41920] transition-all duration-300 hover:bg-[#c41920] hover:text-white">
                  View Residence
