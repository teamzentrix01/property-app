          ...
          {residences.map((residence) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                {/* Button */}
                <Link href={`/listings/${residence.id}`} className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg border border-[Explore Gurugram] py-2.5 text-sm font-semibold text-[Explore Gurugram] transition-all duration-300 hover:bg-[Explore Gurugram] hover:text-white">
                  View Residence
