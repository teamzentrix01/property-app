    ...
    <section className="w-full bg-[#f7f6f3] py-16 sm:py-20 lg:py-12">
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div>
            ...
            <div className="mb-3 flex items-center gap-2">
              <MessageCircle className="h-4 w-4 text-[#c41920]" />
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          {visibleTestimonials.map((testimonial) => (
            ...
            >
              ...
              {/* Quote Icon */}
              <div className="absolute right-5 top-5 flex h-11 w-11 items-center justify-center rounded-full bg-red-50 border border-red-100">
                <Quote className="h-5 w-5 text-[#c41920]" />
              </div>
              ...
              <div className="flex items-center gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    key={star}
                    className="h-4 w-4 fill-[#c41920] text-[#c41920]"
                  />
                ))}
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Avatar */}
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#c41920] text-sm font-bold text-white shadow-sm">
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-1 flex items-center gap-1">
                    <MapPin className="h-3 w-3 text-[#c41920]" />
              ...
              {/* Crimson hover line */}
              <div className="absolute bottom-0 left-0 h-1 w-0 bg-[#c41920] transition-all duration-500 group-hover:w-full" />
            </article>
          ))}
        </div>
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            {testimonials.slice(0, testimonials.length - 2).map((_, index) => (
              <button
                ...
                className={`h-1.5 rounded-full transition-all duration-300 ${active === index
                    ? "w-8 bg-[#c41920]"
                    : "w-2 bg-gray-300"
                  }`}
              />
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-600 transition hover:border-[#c41920] hover:bg-[#c41920] hover:text-white"
            >
        ...
        <div className="relative mt-10 overflow-hidden rounded-2xl bg-[#181818]">
          ...
          {/* Decorative circles */}
          <div className="absolute -right-20 -top-24 h-72 w-72 rounded-full border border-[#c41920]/20" />

          <div className="absolute -right-5 -top-10 h-44 w-44 rounded-full border border-[#c41920]/15" />
          ...
          <div className="relative z-10 flex flex-col gap-6 px-6 py-8 sm:px-9 lg:flex-row lg:items-center lg:justify-between lg:px-12">
            ...
            <Link href="/properties" className="group flex shrink-0 items-center justify-center gap-2 rounded-lg bg-[#c41920] px-7 py-3.5 text-sm font-bold text-white transition hover:bg-[#a51319]">
              Explore Properties
